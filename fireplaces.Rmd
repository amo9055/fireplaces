...
Today, houses in Fairfax County are much more likely to have a fireplace than not, and the highest percentage of houses has one fireplace--the cummulative effect of the building trends of the 1980s and 1990s in Fairfax County.
```{r message = FALSE, echo = FALSE}
require(scales)
library(ggplot2)
